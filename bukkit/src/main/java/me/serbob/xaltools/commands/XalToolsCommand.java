package me.serbob.xaltools.commands;

import me.serbob.xaltools.commands.args.Args;
...
public class XalToolsCommand implements CommandExecutor, TabCompleter {
    @Override
    public boolean onCommand(
        ...
        if (!sender.hasPermission("xaltools.admin"))
            return false;
