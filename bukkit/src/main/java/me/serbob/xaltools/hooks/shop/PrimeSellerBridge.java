...
public class PrimeSellerBridge implements ShopHook {
    ...
    public void init() {
        try {
            ...
            Bukkit.getLogger().info("[XalTools] Successfully hooked into PrimeSeller with " + priceCache.size() + " items cached!");
        } catch (ClassNotFoundException e) {
            Bukkit.getLogger().warning("[XalTools] PrimeSeller not found, hook disabled.");
        } catch (Exception e) {
            Bukkit.getLogger().log(Level.SEVERE, "[XalTools] Failed to hook into PrimeSeller", e);
        }
    }
    ...
    public void refreshCache() {
        ...
        try {
            ...
            Bukkit.getLogger().log(Level.WARNING, "[XalTools] Error refreshing PrimeSeller cache", e);
        }
    }
